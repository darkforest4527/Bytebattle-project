...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .btn-danger:hover { background-color: #ffe4e6; border-color: #f43f5e; }
    .btn-outline { border: 1px solid #d1d5db; color: var(--text-main); background: white; box-shadow: none;}
    .btn-outline:hover { background: #f9fafb; border-color: #9ca3af; }
    
    /* Nav Button Specifics - Ensuring Visibility */
    .btn-nav-primary { 
        background-color: var(--primary); 
    ...
    .btn-registered { background-color: white; color: var(--success); border: 2px solid var(--success); box-shadow: none; }
    .btn-registered:hover { background-color: #f0fdf4; content: "Unregister"; border-color: #059669; color: #059669; }

    /* Tags - Colorful but not neon */
    .tag { font-size: 0.75rem; padding: 0.25rem 0.75rem; border-radius: 9999px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em; }
    .tag-Competition { background-color: #ffedd5; color: #c2410c; } /* Orange */
    .tag-Comedy { background-color: #dbeafe; color: #1e40af; } /* Blue */
    .tag-Workshop { background-color: #e0e7ff; color: #4338ca; } /* Indigo */
    .tag-Seminar { background-color: #f3f4f6; color: #374151; } /* Gray */
    .tag-Social { background-color: #fce7f3; color: #be185d; } /* Pink */
    .tag-Other { background-color: #f3f4f6; color: #374151; }

    /* Forms */
    .form-container { max-width: 450px; margin: 3rem auto; }
    .form-group { margin-bottom: 1.5rem; }
    .form-control { width: 100%; padding: 0.75rem; margin-top: 0.5rem; border: 1px solid #d1d5db; border-radius: 0.5rem; font-size: 1rem; font-family: inherit; transition: border-color 0.2s;}
...
def signup():
    if request.method == 'POST':
        ...
        if users_table.search(User.username == username):
            flash('Username aldready exists', 'error')
        else:
